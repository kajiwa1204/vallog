...
class ErrorCode(StrEnum):
    ...
    # スコア
    SCORES_NOT_DISCLOSED = "SCORES_NOT_DISCLOSED"
    SCORES_WEIGHTS_INCOMPLETE = "SCORES_WEIGHTS_INCOMPLETE"
    SCORES_WEIGHTS_INVALID = "SCORES_WEIGHTS_INVALID"
    # 貢献サマリー
    SUMMARY_PR_NOT_FOUND = "SUMMARY_PR_NOT_FOUND"
    # 分配シミュレーション
    DISTRIBUTION_NOT_FOUND = "DISTRIBUTION_NOT_FOUND"
    DISTRIBUTION_FINALIZED = "DISTRIBUTION_FINALIZED"
    DISTRIBUTION_NO_MEMBERS = "DISTRIBUTION_NO_MEMBERS"
    DISTRIBUTION_RATIO_TOTAL_INVALID = "DISTRIBUTION_RATIO_TOTAL_INVALID"
